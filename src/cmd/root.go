...
var rootCmd = &cobra.Command{
	...
	Version: "0.30.00 (" + time.Now().Format("2006.01.02") + "), Go version = " + runtime.Version(),
...
func init() {
	...
	rootCmd.AddCommand(envCmd, repoCmd, blobCmd, assetsCmd, assetsUploadCmd, assetsDownloadCmd, reindexRepoCmd)
